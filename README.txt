------------------------------------------------
This is a java GUI application to parse and play .abc music files.

INSTRUCTION
------------------------------------------------
1. Run the ABCPlayerController.java file under src/controller/ directory to start the GUI.
...
5. Press the stop button, the application will stop play.
